...
| 피처 | 설명 | 출처 |
|------|------|------|
| `institutional_demand_ratio` | 통합 기관 수요예측 경쟁률 | DART 최종 `[발행조건확정]` 원문 표 (1차), 대표주관사 공식 통합 결과 공지 (보조) |
| `lockup_6m_ratio` | 6개월 의무확약 비율 | DART 최종 `[발행조건확정]` 원문 표 (1차), 대표주관사 공식 통합 결과 공지 (보조) |
| `lockup_3m_ratio` | 3개월 의무확약 비율 | DART 최종 `[발행조건확정]` 원문 표 (1차), 대표주관사 공식 통합 결과 공지 (보조) |
| `lockup_1m_ratio` | 1개월 의무확약 비율 | DART 최종 `[발행조건확정]` 원문 표 (1차), 대표주관사 공식 통합 결과 공지 (보조) |
| `lockup_15d_ratio` | 15일 의무확약 비율 | DART 최종 `[발행조건확정]` 원문 표 (1차), 대표주관사 공식 통합 결과 공지 (보조) |
...
1. IPO 상장 일정을 확인한다.
2. 상장 전 DART 신고서에서 공모가 밴드, 확정 공모가, 신주·구주매출, 직접 공시된 유통물량, 최대주주 보호예수, 재무제표를 수집한다. 최종 `[발행조건확정]` 원문에 기관 수요예측·의무보유확약의 단일 통합 표가 직접 있으면 같은 접수번호의 값만 승인한다. 공동주관사별 수치를 평균·합산하지 않으며, DART 원문이 없거나 통합 표가 없을 때만 대표주관사의 공식 통합 결과 공지를 보조 원천으로 검증한다.
   개인청약 경쟁률은 수집·모델·서비스 입력 범위에서 제외한다.

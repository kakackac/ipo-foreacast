...
| 피처 | 설명 | 출처 |
|------|------|------|
| `institutional_demand_ratio` | 기관 수요예측 경쟁률 | 검증된 주관사 공식 결과 공지 (현재 수집기 미구현) |
| `lockup_6m_ratio` | 6개월 의무확약 비율 | 검증된 주관사 공식 결과 공지 (현재 수집기 미구현) |
| `lockup_3m_ratio` | 3개월 의무확약 비율 | 검증된 주관사 공식 결과 공지 (현재 수집기 미구현) |
| `lockup_1m_ratio` | 1개월 의무확약 비율 | 검증된 주관사 공식 결과 공지 (현재 수집기 미구현) |
| `lockup_15d_ratio` | 15일 의무확약 비율 | 검증된 주관사 공식 결과 공지 (현재 수집기 미구현) |
...
1. IPO 상장 일정을 확인한다.
2. 상장 전 DART 신고서에서 공모가 밴드, 확정 공모가, 신주·구주매출, 직접 공시된 유통물량, 최대주주 보호예수, 재무제표를 수집한다. 기관 수요예측 경쟁률·의무보유확약은 검증된 주관사 공식 결과 수집기가 준비되기 전까지 결측으로 유지한다.
